...
                    className={`w-full h-36 rounded-2xl overflow-hidden border-4 shadow-2xl transition-all duration-300 ${
                      isDarkMode
                        ? "border-gray-800"
...
                className={`tracking-wider mb-2 text-lg transition-all duration-300 font-semibold ${
...
                className={`text-4xl md:text-5xl mb-4 leading-snug font-extrabold ${
                  isDarkMode
                    ? "text-white"
...
              {/* Buttons - HORIZONTAL AND SMALLER */}
              <motion.div
                variants={itemVariants}
                className="flex flex-row space-x-4 mb-12 justify-start" // <--- CHANGED: flex-row, space-x-4, justify-start
              >
                <motion.button
                  whileHover={{
                    y: -2,
...
                  className="bg-blue-500 hover:bg-blue-600 cursor-pointer text-white px-6 py-2 rounded-full text-sm uppercase tracking-wider font-semibold transition-all duration-300 " // <--- CHANGED: px-6, py-2, text-sm, removed w-full
                >
                  View Work
                </motion.button>
...
                  }}
                  whileTap={{ scale: 0.98 }}
                  className={`border px-6 py-2 rounded-full text-sm uppercase tracking-wider font-semibold flex items-center gap-2 transition-all duration-300 ${ // <--- CHANGED: px-6, py-2, text-sm, removed w-full, removed justify-center
                    isDarkMode
